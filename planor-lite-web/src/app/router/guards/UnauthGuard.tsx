 ...
 * - Si el usuario ESTÁ autenticado, lo redirige a la ruta principal (/).
...
export const UnauthGuard = () => {
  ...
  // Si está autenticado, redirige a / y reemplaza la entrada del historial (evita volver atrás a la página pública)
  if (isAuthenticated) {
